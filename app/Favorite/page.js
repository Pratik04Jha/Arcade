...
const FavoritePage = async () => {
  const userId = "user123"; // use Firebase Auth later
  ...
  return (
    <div className="p-4 h-screen  flex items-center pt-20 flex-col">
      <div className="flex flex-wrap justify-center items-center gap-10">
        {favorites.map((games) => (
         <div key={games.id} className="group relative w-[22rem] h-[26rem] py-2 px-2 rounded-3xl overflow-hidden transition-all duration-500 transform scale-[1.025] cursor-pointer hover:scale-[1.05]  hover:border-zinc-700 hover:rotate-[0.3deg] backdrop-blur-md">
               {/* Image Section */}
               ...
               <div className="px-5 py-4 text-center flex flex-col justify-center">
                 ...
                 <p className="text-sm text-zinc-300 mt-2">{games.gameDescription}</p>
